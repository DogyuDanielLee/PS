...
int64_t rangeSum(SegementTree *s_tree, int64_t L, int64_t R, int64_t idx,
  ...
  return rangeSum(s_tree, L, R, idx * 2, node_L, mid) +
         rangeSum(s_tree, L, R, idx * 2 + 1, mid + 1, node_R);
}
